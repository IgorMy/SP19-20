function Funcion_Reconoce_Formas(rutaFicheroImagen)
    ...
    rutaParcialFichero = '../../02_FaseEntrenamiento/CASOA_MDE_clases2a2/';
    % Circulo-Cuadrado
    rutaFichero = '01_CirculoCuadrado/02_DisegnoClasificador/DatosGenerados/';
    nombreFichero = 'MDE_circ_cuad.mat';
    ...
    nombreFichero = 'MDE_circ_trian.mat';
    load([rutaParcialFichero rutaFichero nombreFichero]);
    ...
    nombreFichero = 'MDE_cuad_trian.mat';
    load([rutaParcialFichero rutaFichero nombreFichero]);
