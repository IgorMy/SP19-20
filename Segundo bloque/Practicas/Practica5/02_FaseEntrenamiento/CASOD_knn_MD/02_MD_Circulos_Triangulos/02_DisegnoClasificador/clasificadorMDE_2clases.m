...
[d1,d2,d12MDE,coeficientes_d12MDE] = funcion_calcula_funciones_decision_MDE_clasificacion_binaria(XoIRed,YoIRed);
[d1,d2,d12MDM,coeficientes_d12MDM] = funcion_calcula_funciones_decision_MDM_clasificacion_binaria(XoIRed,YoIRed);
...
%% Guardamos los datos
save('./DatosGenerados/MD_circ_trian','espacioCcas', 'd12MDM','d12MDE', 'coeficientes_d12MDM', 'coeficientes_d12MDE', 'XoIRed', 'YoIRed', 'nombresProblemaIORed');