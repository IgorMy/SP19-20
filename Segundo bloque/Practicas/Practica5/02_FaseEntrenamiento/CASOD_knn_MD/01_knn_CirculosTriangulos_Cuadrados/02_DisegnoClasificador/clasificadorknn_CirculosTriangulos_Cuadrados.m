...
nombreFichero = 'espacio_ccas_knn_CirculosTriangulos_Cuadrados.mat';
...
save('./DatosGenerados/knn_CirculosCuadrados_Triangulos','espacioCcas', 'XoIRed', 'YoIRed', 'nombresProblemaIORed');