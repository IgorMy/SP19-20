function Funcion_Reconoce_Formas(rutaFicheroImagen,Tipo)
    ...
    rutaFichero = '../../02_FaseEntrenamiento/CASOC_knn_3clases/02_DisegnoClasificador/DatosGenerados/';
    nombreFichero = 'knn.mat';
    ...
    if sum(sum(Ibin_filt)) > 0
        ...
        for i=1:N
          ...
          YTest = funcion_knn (ZRed(i,:), XoIRed, YoIRed, 9, Tipo);
